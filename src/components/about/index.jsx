        ...
        <div className="about-main__wrapper">
          ...
          <div className="about-section__wrapper">
            ...
            <p className="section__paragraph">
              ...
              sunt Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
          ...
          <div className="our-values__wrapper">
            ...
            <ul className="our-values__list">
              <li>
                <span className="our-values__sub-header">
                  We Value our Customers:{" "}
                </span>{" "}
                Lorem ipsum dolor sit amet, sed do eiusmod tempor incididunt ut
                labore et dolore magna aliqua esse cillum dolore eu fugiat nulla
                pariatur labore et dolore magna aliqua esse cillum dolore eu
                fugiat nulla pariatur nulla pariatur labore et dolore magna
                aliqua esse cillum dolore eu fugiat nulla pariatur.
              </li>
              <li>
                <span className="our-values__sub-header">
                  We Value Innovation:{" "}
