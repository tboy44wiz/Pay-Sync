    ...
    <div className="footer-main">
      <div className="footer-left">
        ...
        <div className="footer-msg">
          We believe that the option of employees' accessing their earned salary
          on a daily basis is the first step on the road to prosperity
        </div>
      ...
      <div className="menu-info__wrapper">
        ...
        <div className="footer-info">
          ...
          <h6>Cookie Policy </h6>
          <h6>Terms Apm startnd Conditions</h6>
          <h6>Contact Us</h6>
        </div>
      </div>
